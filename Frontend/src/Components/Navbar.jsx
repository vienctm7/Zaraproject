            ...
            <Container theme={theme} style={{ backgroundColor: location.pathname === '/' ? 'transparent' : 'white' }}>
                ...
                <div className='navRightSection' style={{zIndex:!val?'0':'10'}}>
                    ...
                    <div >
                        ...
                        {/* {isAuth ? <Link to='/'> <span>{isAuth.name}</span></Link> : <></>} */}
                        <Link to="/help">
                        ...
                        <Link to="/cart">
                            ...
                            <span style={{ position: 'relative', right: cartData && cartData.length > 9 ? '21px' : '18px', top: "-10px", fontSize: '12px' }}>{isAuth?cartData.length:'0'}</span>
                        </Link>
                    </div>
                </div>
            </Container>
